...
<div className="max-w-7xl mx-auto p-6">
    ...
    <div className="bg-white shadow rounded-2xl p-6 mb-6">
        ...
        <p><strong><button className='bg-orange-300 text-red-500 p-2 rounded shadow'>✏️Edit</button></strong></p>
    </div>
    {/* layout */}
            ...
            <div key={post._id} className="bg-white rounded shadow p-4 mb-4">
              ...
              <div className="flex space-x-6">
                <div className="mt-2">
                    ...
                    <span className="font-semibold">{post.likes.length} {post.likes.length>1?'Likes':'Like'} </span>
                    </div>
                    <div className="mt-2">
                    <button className="bg-purple-500 text-white font-bold rounded px-3 py-1 mr-2">
                    💬
                        </button>
                    <span className="font-semibold">{post.comments.length} {post.comments.length>1?'Comments':'Comment'} </span>
                    </div>
                    </div>
            </div>
          ))}
